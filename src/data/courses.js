...
With consistency: 2–4 weeks to mostly reliable, 4–6 months to fully reliable. Small breeds often take longer than large breeds.`,
        checklist: [
          "Taking puppy out immediately after every wake/eat/play",
          "Rewarding outdoor potty with treat and praise every time",
          "Enzyme cleaner purchased for indoor accidents",
          "Not punishing accidents after the fact",
          "Crate sized correctly (not too big)",
          "Puppy not given free roam when unsupervised",
          "Learning puppy's pre-potty signals",
        ],
      },
      {
...
Most puppy problems are temporary. The behaviors that frustrate owners most during the first few months are often completely normal developmental stages. Every behavior is either being reinforced or redirected, always stay consistent.`,
        checklist: [
          ...
          "Chew toys available and rotated regularly",
          "Unsupervised time = crate or confined space",
          "Jumping: turning back and rewarding 4-paws-on-floor",
          "Food not left at counter/puppy level",
          "Short departures being practiced for separation prep",
        ],
      },
      {
...
**As they get older:**
By 4 months, many puppies can hold it for 3–4 hours during the day and sleep through the night. By 6 months, their schedule starts to look more like an adult dog's — 2 meals, 3–4 outdoor trips, longer awake periods.`,
        checklist: [
          "Written schedule posted somewhere visible",
          "Potty trips happening after every wake/eat/play",
          "Puppy getting 4–6 nap periods per day",
          "Training sessions 5 min or less",
          "Evening wind-down routine in place",
          "No free-roaming without supervision yet",
        ],
      },
    ],
    printables: [
...
Place is more than a command. It's an off-switch. It's a way to help your dog relax, settle, and understand exactly what is expected of them. A reliable place command creates structure, reduces chaos, and gives your dog a clear job during situations that might otherwise be overwhelming.`,
        checklist: [
          ...
          "Duration being built in the same way as sit/stay",
...
**Spin** — Lure your dog in a circle with a treat. Mark at completion. Build speed over repetitions. Add "spin" or "twist" as the verbal cue.
...
**Around** — Place a cone, chair, tree, or other object nearby. Lure your dog around it and reward when they complete the circle. Great for building body awareness and directional signals.`,
        checklist: [
          ...
          "'Drop it' being practiced with trades",
          "At least one fun trick started",
          "Nose target introduced",
          "Training sessions staying fun and short",
        ],
      },
    ],
    printables: [
...
When you see early stress signals in training — your dog is telling you the session is too hard, too long, or too distracting. Adjust rather than push through. A dog that feels heard and safe learns faster. Once you can read those signals, you'll stop guessing how your dog feels.`,
        checklist: [
          ...
          "Not mistaking arousal for happiness",
          "Reducing pressure when stress signals appear",
          "Understanding that growling is communication, not just bad behavior",
          "Filming dog in new situations to review signals later",
        ],
      },
      {
...
You don't need to catch every problem. You just need to notice when something isn't normal. Nobody sees your dog more than you do, and that makes you one of the most important parts of their healthcare team.`,
        checklist: [
          ...
          "Body condition checked by feel (not just by weight)",
          "Vaccines current and documented",
          "Heartworm prevention on calendar",
          "Emergency vet location saved in your phone",
  ...
  },
  {
    ...
    price: 0,
    bundleOnly: true,
    tagline: "Real fixes for the issues many owners eventually face.",
    ...
    lessons: [
      {
        ...
        content: `Leash reactivity is one of the most common problems dog owners face and one of the most misunderstood. A reactive dog is not usually an aggressive dog, they are an overwhelmed dog.

**Why it happens:**
The leash prevents your dog from doing what they'd naturally do when something approaches — either investigate or move away. That loss of choice can create frustration and anxiety, which comes out as lunging, barking, or spinning. The leash also transmits your tension directly to your dog through your grip and body language.

**The fix — Desensitization and Counter-Conditioning:**
...
Threshold training aims to change your dog's emotional response to a trigger rather than simply stopping the outward behavior. Start by identifying your dog's threshold, the distance where they can notice the trigger while remaining calm and able to respond to you. The moment the trigger appears, begin delivering high-value treats. When the trigger disappears, the treats stop. Over many successful repetitions, your dog learns that the presence of the trigger consistently predicts something positive, helping replace anxiety or frustration with a more relaxed emotional response and encourage focus on you.

**Management while you train:**
Avoid situations you can't control. Cross the street early; before your dog notices the trigger, not after. Keep the leash loose, a tight leash signals danger to your dog and makes things worse. Stay calm, dogs can sense your emotional state.
...
Weeks to months depending on severity and consistency. This is not a quick fix — it is a genuine behavior modification protocol. Stay consistent and you will see results.`,
        checklist: [
          ...
          "Keeping leash loose and remain calm",
...
**What makes it worse:**
Taking things away repeatedly. Punishing the growl. Reaching into the bowl while eating. These approaches suppress the warning signals without addressing the emotion, and create dogs that bite without warning.

**The fix — Trading Up:**
Approach your dog when they have something and offer something better. The moment they drop the item, give the trade and let them have the original item back too. You are teaching that a person approaching means good things, not loss.

**Bowl exercises:**
While your dog eats, approach and drop something high value into their bowl, then walk away. Repeat every meal. Over weeks, your dog starts looking up at you when you approach the bowl instead of hunching over it. That's the emotional shift you're after.

**Hand Feeding:**
Hand feeding can help reduce resource guarding by teaching your dog that your presence around food consistently predicts something positive rather than something being taken away. 

**Prevention in puppies:**
Never take things from puppies "to establish dominance." Instead practice trades constantly from day one. Puppies that learn people approaching means good things rarely develop resource guarding.
...
Your response to demand barking determines whether it continues. If you ever give them what they want when they bark, even once, you have reinforced it. The fix: turn your back, leave the room, give zero attention. Reward quiet. This can get worse before it gets better.
...
**General tips:**
Never yell at a barking dog. Keep your response calm and consistent. Management (removing the dog from the window they bark at all day) is a valid tool while you work on training.`,
        checklist: [
...
Most dogs have distress (uncomfortable alone) not clinical anxiety (panic). Distress is much easier to address. True severe anxiety often needs professional support; medication combined with behavior modification gets significantly better results than behavior modification alone.
...
**What helps:**
Calm departures and arrivals, no emotional goodbyes. A stuffed Kong when you leave, camera to monitor and exercise before alone time. A well-crate-trained dog often has an easier time because the crate itself is calming.
...
**When to see a vet:**
If your dog cannot be left alone for even 30 seconds without panicking, consult a veterinary behaviorist.`,
        checklist: [
...
**Why owners do it:**
It feels like a reminder, like clearer communication. It feels wrong to just stand there in silence.
...
If your dog doesn't respond to a quiet, single cue in a low-distraction environment, the behavior needs more work, not more repetitions.`,
      ...
      },
      {
        ...
        content: `A reward or marker word marks the behavior that was happening at the exact moment it was delivered. Not the behavior before it. Not the behavior you were hoping for. The behavior at that precise second.

**Common timing mistakes:**
Calling your dog to come, they arrive, you reach for the treat, they begin to walk off, and you reward that, not the recall.

Asking for a down, dog lies down, you walk to get a treat. They stand up by the time you return, and you reward the stand.
...
Your dog makes eye contact during heel, but by the time you reward they've already looked away, so you reinforce breaking focus.

Teaching "place," your dog gets on the bed, but you wait until they step off before rewarding, reinforcing leaving the place.
...
**The rule:**
The moment you notice frustration, end the session. Not after one more try, immediately. Put the treats away, take a breath, do something else. Come back another time.
...
**The prerequisites:**
Before going off leash in an open area, your dog needs: a reliable recall that works on a long line with distractions, solid engagement (they check in with you regularly without being asked), and at least 6 months of consistent obedience foundation.

**The long line bridge:**
Go from on-leash to off-leash via a long line (15–30 ft). The long line gives you the ability to enforce recall without chasing. Practice until the recall on the long line is so reliable it feels boring. Then drop the long line (let it drag) so the dog doesn't feel the weight difference. Then pick it up and put it away.

**Proofing for real life:**
Off-leash doesn't mean uncontrolled. It means your verbal cues work without the physical backup. Proof every command off-leash in low distraction before adding distractions. Start in the backyard, then quiet park, then a park with people, then a park with dogs.
...
**The e-collar:**
The e-collar (electronic collar) allows you to give your dog off leash freedom while still having control. Some are equipt with GPS tracking, some with tone to recall your dog from distance without making a sound, or deliver a stim or vibrate. Dogs should still have reliable recall and obedience while using an e-collar, tools can fail, electronics can die or break. The e-collar adds an extra layer of protection to off-leash freedom.
...
Any time your dog's recall becomes unreliable. Off-leash is a privilege that gets earned repeatedly, not granted permanently.`,
        checklist: [
          ...
          "Using a reliable brand of e-collar for safety",
...
Your dog learned the behavior in only one context. The treat pouch, the training posture, the familiar room — these all become part of the cue. Take them away and the dog genuinely doesn't know what's being asked. This is called context specificity and it's completely normal.
...
**Nosework / Scent Work:**
The most accessible dog sport. Dogs search for a specific odor hidden in boxes, rooms, vehicles, and outdoor areas. Any breed, any age, any fitness level. Mentally exhausting in the best way. Organizations: AKC Scent Work, NACSW.
...
**Schutzhund / IGP / PSA:**
Protection sport with tracking, obedience, and protection phases. Primarily for working breeds (GSD, Malinois, Rottweiler, Doberman). Requires a club. It is not about making dogs aggressive, it's a rigorous test of nerve, drive, and trainability. PSA does not nclude tracking.
...
Search for local clubs for any sport that interests you. Most offer intro classes. Watching a trial before signing up gives you a feel for the sport.`,
  ...
  {
    id: "exclusive-vetgroomer",
    tag: "Bundle Exclusive",
    title: "Vet & Groomer Preparation",
    price: 0,
    bundleOnly: true,
    tagline: "Turn vet visits and grooming sessions from a struggle into a non-event.",
    description: "Cooperative handling, muzzle conditioning, and nail trim desensitization — practical prep so vet and groomer visits stop being a fight.",
    includes: [],
    lessons: [
      {
...
**On the day:**
Bring high-value treats the vet or groomer can use. Ask staff to go slow and let your dog opt in using the chin rest if trained. A five-minute slower appointment now saves years of a dog that needs to be muzzled and forced for basic exams.`,
        checklist: [
          "Chin rest trained and reliable at home",
      ...
      {
        title: "Muzzle & Restraint Conditioning",
        content: `A muzzle is a safety tool, not a punishment, and the way you introduce it determines whether your dog sees it that way too.

**Why muzzle train every dog, not just 'aggressive' ones:**
...
Once conditioned, a muzzle can be put on calmly before a stressful procedure, and removed as soon as it's done, ending the appointment on a positive note.`,
        checklist: [
          "Dog voluntarily pushes nose into muzzle for treats",
...
If your dog is already highly reactive to nail trims, a groomer or vet tech experienced in low-stress handling — or a muzzle, per the previous lesson — is a reasonable bridge while you build the underlying tolerance.`,
        checklist: [
          ...
          "Low-stress handling professional used as a bridge if needed",
        ],
      },
    ],
    printables: [],
...
Keep your dog leashed where required, and give other hikers, horses, and wildlife space by default — not every dog or person on the trail wants a greeting.`,
        checklist: [
          "Distance built up gradually, not jumped into",
          "Solid leash manners and recall practiced before the trip",
          "Well-fitted harness and enough water for both of you packed",
          "Paw pad heat-tested on trail surface before setting out",
          "Signs of heatstroke and overexertion known in advance",
        ],
      },
      {
        title: "Road Trips & Pit Stops",
        content: `A dog that's never practiced car travel can turn a road trip into a stressful ordeal for everyone in the vehicle.

**Safety first:**
An unrestrained dog in a moving vehicle is a hazard in an accident and a distraction beforehand. A crash-tested crate or harness restraint suited to your dog's size is worth the investment before a long trip.

**Building car tolerance:**
If your dog gets carsick or anxious, start with the engine off, then short trips around the block, gradually increasing duration. Feeding meals in the car while parked can help build a positive association before you ever drive anywhere.

**Planning stops:**
Plan a stop every 2–3 hours minimum for water, a bathroom break, and a short walk to release energy. Research dog-friendly rest stops or parks along your specific route in advance rather than hoping you'll find one.

**Hotel and lodging etiquette:**
...
Food (enough for the whole trip plus extra), medications, poop bags, a first-aid kit, proof of vaccination records, and a recent photo of your dog in case of separation.`,
        checklist: [
          ...
          "Stops planned every 2–3 hours along the route",
          "Pet policy confirmed directly with lodging before booking",
          "Full packing list — food, meds, records, photo — assembled before departure",
        ],
      },
      {
        title: "Public Etiquette & New Environments",
        content: `How your dog behaves in public reflects both training and setup. A little preparation goes a long way toward a dog that's actually welcome to bring along.

**Reading "dog-friendly" correctly:**
Dog-friendly means dogs are allowed, not that every dog there wants to meet yours. Keep greetings by consent from both the other dog's handler and your own dog's body language, not by default.

**Managing arousal in new places:**
...
Find your dog's favorite place`,
  ...
  {
    id: "exclusive-highenergy",
    tag: "Bundle Exclusive",
    title: "Life with a High-Energy Dog",
    price: 0,
    bundleOnly: true,
    ...
    lessons: [
      {
        title: "Structured Physical Outlets",
...
Breed, age, and health all matter. A young working-line dog may need more than a senior or a breed with lower baseline drive — know your specific dog rather than following generic exercise minutes.`,
        checklist: [
          ...
          "Every high-arousal session ends with a deliberate calm-down period",
          "Exercise plan matched to this dog's age, breed, and health, not a generic number",
          "Off-switch cue (settle, place, etc.) trained and used consistently",
        ],
      },
      {
        title: "Mental Enrichment That Actually Tires Them Out",
...
Rotate toys and puzzles rather than leaving everything out permanently. Novelty itself is enriching, and a rotated toy gets re-engaged with as if it were new.`,
      ...
      {
        title: "Managing the Witching Hour",
        content: `Almost every high-energy dog owner knows the same window — a period, often evening, when a dog seems to combust with zoomies, mouthing, or general chaos no matter how much exercise happened earlier.
...
If the behavior seems distressed rather than playful such as excessive panting, inability to settle even after redirection, self-harm rather than classic zoomies, it's worth mentioning to your vet, since some hyperactivity has a medical component.`,
        checklist: [
          ...
          "Environment set up in advance (safe space, appropriate chews ready)",
          "Redirection used instead of trying to force stillness",
          "Vet consulted if the behavior seems distressed rather than playful",
        ],
      },
    ],
    printables: [],
...
export const BUNDLE = {
  ...
  exclusive: [
    {
      title: "Problem Solving Guide",
      desc: "Real fixes for leash reactivity, resource guarding, excessive barking, and separation anxiety — the issues every owner eventually faces.",
    },
    {
      title: "Handler Mistakes",
      desc: "The most common owner errors that quietly sabotage training — and exactly how to identify and correct them.",
    },
    {
      title: "Advanced Tips & Tricks",
      desc: "Next-level skills to build on your foundation — off-leash reliability, sport foundations, advanced commands, and working with distractions.",
    },
    {
      title: "Vet & Groomer Preparation",
      desc: "Cooperative handling, muzzle conditioning, and nail trim desensitization — so vet and groomer visits stop being a fight.",
    },
    {
      title: "Dog-Friendly Adventure Checklist",
      desc: "The gear, training, and etiquette for hiking, road trips, and public spaces — so you can bring your dog along safely, wherever you're headed.",
    },
    {
      title: "Life with a High-Energy Dog",
      desc: "Structured outlets, mental enrichment, and realistic strategies for owners of high-drive breeds and dogs with energy to spare.",
    },
  ],
};
